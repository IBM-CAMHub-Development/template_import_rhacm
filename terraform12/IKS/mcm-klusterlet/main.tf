...
module "cluster-credentials" {
  source  = "git::https://github.com/IBM-CAMHub-Development/template_mcm_modules.git//terraform12/cluster_credentials?ref=5.0.0"
...
module "cluster-import" {
  source  = "git::https://github.com/IBM-CAMHub-Development/template_rhacm_modules.git//cluster_import?ref=5.1.0"
